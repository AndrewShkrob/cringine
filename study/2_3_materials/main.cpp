...
int main()
{
    ...
    window.launch([&]() {
        ...
        lightingShader.set_uniform_3f("material.ambient", 1.0f, 0.5f, 0.31f);
        lightingShader.set_uniform_3f("material.diffuse", 1.0f, 0.5f, 0.31f);
        lightingShader.set_uniform_3f("material.specular", 0.5f, 0.5f, 0.5f);
