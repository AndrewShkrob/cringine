...
namespace cringine::event_system
{
    ...
    public:
        ...
        void register_window_focus_callback(events::window_focus_event_ptr callback) override;
        void register_window_refresh_callback(events::window_refresh_event_ptr callback) override;
        void register_window_iconify_callback(events::window_iconify_event_ptr callback) override;
        void register_window_maximize_callback(events::window_maximize_event_ptr callback) override;
        void register_keyboard_input_callback(events::keyboard_input_event_ptr callback) override;
        void register_char_input_callback(events::char_input_event_ptr callback) override;
        void register_cursor_position_callback(events::cursor_position_event_ptr callback) override;
        void register_cursor_focus_callback(events::cursor_focus_event_ptr callback) override;
        void register_mouse_button_input_callback(events::mouse_button_input_event_ptr callback) override;
        void register_scroll_input_callback(events::scroll_input_event_ptr callback) override;
        void register_path_drop_callback(events::path_drop_event_ptr callback) override;
